...
export const UserItem = ({ user, openModalHandler }) => {
	return (
		<>
			<tr>
				<td>
				...
				<td className="actions">
					<button
						...
						title="Edit"
						onClick={() =>
							openModalHandler(user._id, UserActions.Edit)
						}
					>
						<svg
							aria-hidden="true"
					...
					<button
						...
						title="Delete"
						onClick={() =>
							openModalHandler(user._id, UserActions.Delete)
						}
					>
						<svg
							aria-hidden="true"
					...
					<button
						...
						title="Info"
						onClick={() =>
							openModalHandler(user._id, UserActions.Details)
						}
					>
						<svg
							aria-hidden="true"
